...
import { orderBook } from "@/api/order/BookOrder";
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.title === "修改图书库存") {
            ...
            // 订购图书调用orderBook接口
            orderBook(this.form).then(response => {
              this.$modal.msgSuccess("订购成功");
              this.open = false;
              this.getList();
            });
          }
